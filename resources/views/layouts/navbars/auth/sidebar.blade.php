<style>
    .nav-link.active {
        ...
        /* Reemplaza con tu color preferido en formato hexadecimal o nombre de color */
        color: #fff;
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            <img src="https://embol.com/small/embolHeaderIconDark.svg" class="navbar-brand-img h-100" alt="...">
            <span class="ms-3 font-weight-bold">Embol</span>
        </a>
    </div>
            ...
            @if (Auth::user()->rol === 'Administrador')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('areas') ? 'active' : '' }} " href="{{ route('areas.index') }}">
                        ...
                        <span class="nav-link-text ms-1">Areas De Trabajo</span>
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link {{ Request::is('empresas.index') ? 'active' : '' }} "
                        ...
                        <span class="nav-link-text ms-1">Gestionar Empresa</span>
                    </a>
                </li>
            @endif
            ...
            @if (Auth::user()->rol !== 'Administrador')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('trabajos') ? 'active' : '' }}"
                        ...
                        <span class="nav-link-text ms-1">Ofertas Laborales</span>
                    </a>
                </li>
            @endif
